...
export default function About() {
    return (
        <div className='about-div'>
            ...
            I am a Full Stack Web Developer with a Bachelors in Business and Psychology. I am currently earning a Certificate in Full Stack Web Development from Carleton University where I have developed skills in JavaScript, Node.js, Express.js, SQL, CSS, and HTML.
